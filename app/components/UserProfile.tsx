...
export function UserProfile() {
  ...
  if (!user) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50">
        <div className="text-center">
          <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-telegram-500 mx-auto mb-4"></div>
          <p className="text-gray-600">Создание профиля...</p>
        </div>
      </div>
    )
  }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-telegram-50 to-blue-50 p-4">
          ...
          <div className="p-6 space-y-4">
            ...
            <div className="flex items-center justify-between py-3 border-b border-gray-100">
              <div className="flex items-center">
                <div className="w-8 h-8 bg-telegram-100 rounded-lg flex items-center justify-center mr-3">
                  <svg className="w-4 h-4 text-telegram-600" fill="currentColor" viewBox="0 0 20 20">
                    <path d="M2.003 5.884L10 9.882l7.997-3.998A2 2 0 0016 4H4a2 2 0 00-1.997 1.884z" />
                    <path d="M18 8.118l-8 4-8-4V14a2 2 0 002 2h12a2 2 0 002-2V8.118z" />
                  </svg>
                </div>
                <span className="text-gray-700 font-medium">Telegram ID</span>
              </div>
            ...
            <div className="flex items-center justify-between py-3 border-b border-gray-100">
              <div className="flex items-center">
                ...
                <span className="text-gray-700 font-medium">Дата регистрации</span>
              </div>
            ...
            <div className="flex items-center justify-between py-3">
              <div className="flex items-center">
                ...
                <span className="text-gray-700 font-medium">Обновлен</span>
              </div>
              <span className="text-gray-900 text-sm">
